...
namespace MoreMountains.NiceVibrations
{
    ...
    public class MMNVAHAP
    {
        ...
        {
            MMNVAHAP ahap = JsonUtility.FromJson<MMNVAHAP>(AHAPasString);
        ...
        {
            MMNVAHAP ahap = JsonUtility.FromJson<MMNVAHAP>(AHAPasString); //JsonConvert.DeserializeObject<MMNVAHAP>(AHAPasString);
