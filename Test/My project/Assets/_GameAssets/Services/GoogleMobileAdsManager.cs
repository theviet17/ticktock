...
public class GoogleMobileAdsManager : Singleton<GoogleMobileAdsManager>
{
    ...
    {
        yield return new WaitForSecondsRealtime(1);//RemoteConfigControl.I.capping_ads.GetValue());
  ...
  private string _adUnitId = "ca-app-pub-3940256099942544/1712485313";
    ...
    private void HandleUserEarnedReward()
    {
        ...
        //// Gọi callback khi người dùng nhận thưởng
        //OnUserEarnedRewardCallback?.Invoke();

        //// Thực hiện các hành động thưởng ở đây, ví dụ như tăng điểm, cấp vật phẩm, v.v.
        //GrantReward(e);
    }
}